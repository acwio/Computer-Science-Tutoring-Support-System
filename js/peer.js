/*
	file:			peer.js
	modifed by:	alex c. williams
	description:
	this file implements the video/audio chat using IDs between users to
	connect video and audio streams via the peer.js hub server.
*/
